...
const Stories = ({item}) => {
  ...
  const [visible, setVisible] = React.useState(false);
    ...
    const containerStyle = {backgroundColor: 'transparent', padding: 20,alignItems:'center'};
  ...
  return (
    <View style={{marginHorizontal:10,marginVertical:10}}>
        ...
        <Image
        source={{uri: item.profileimage}}
        style={{width:70,height:70,borderRadius:35,borderColor:'pink',borderWidth:3,resizeMode:'contain'}}
        />
        </TouchableOpacity>
